"""
recal_core.reporter.figures
=======================
Genera 4 figuras matplotlib para el reporte RECAL.
...
def figure_quadrant_map(profile: DriftProfile, figsize=(9, 7)) -> plt.Figure:
    ...
    ax.set_title("RECAL: Feature quadrant map", fontsize=12)
...
def figure_calibration_curve(
    ...
    if scores_after is not None:
        _plot_calibration(ax, y_true, scores_after, "After (RECAL)", "#2196F3", "^")
