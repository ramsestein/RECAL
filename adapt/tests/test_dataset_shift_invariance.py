"""
adapt/tests/test_dataset_shift_invariance.py
==============================================
...
class TestDesignerDecisionMonotonicity:
    ...
    def test_mask_threshold_monotone(self):
        ...
        from adapt.profiler.constants import N_EVENTS_MINIMUM_MASK
    ...
    def test_woe_threshold_monotone(self):
        ...
        from adapt.profiler.constants import N_EVENTS_MINIMUM_WOE
    ...
    def test_calibration_threshold_monotone(self):
        ...
        from adapt.profiler.constants import N_EVENTS_MINIMUM_CALIBRATION
