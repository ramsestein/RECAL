...
Sin hiperparámetros: todos los thresholds están en adapt/profiler/constants.py.
...
class Profiler:
    ...
    están auditables en adapt/profiler/constants.py.
