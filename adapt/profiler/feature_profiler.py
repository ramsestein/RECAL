"""
adapt.profiler.feature_profiler
=================================
profile_features(): calcula el perfil de cada feature del par (source, target).

Reutiliza:
- domain_transfer.drift.concept_shift_univariate para beta3 y qbh
- domain_transfer.select.combined_score para lbase + shap + combined_score
- adapt.profiler.quadrant para la asignación de cuadrantes
...
def profile_features(
    ...
    # ── 3. Combined score ─────────────────────────────────────────────────────
    # Usamos CombinedScoreSelector para consistencia con domain_transfer
