"""
domain_transfer.drift.analyzer
================================
...
señales de P(X) — ver ``domain_transfer.select.meta_drift``.
"""
...
from domain_transfer.select.meta_drift import compute_drift_features
